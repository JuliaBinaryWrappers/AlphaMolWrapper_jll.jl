# `AlphaMolWrapper_jll.jl` (v0.2.0+0)

[![deps](https://juliahub.com/docs/AlphaMolWrapper_jll/deps.svg)](https://juliahub.com/ui/Packages/AlphaMolWrapper_jll/BFn8W?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/1f215b8b9e534989f216b8d90e7ea24362e35862/A/AlphaMolWrapper/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `AlphaMolWrapper_jll.jl` have been built from these sources:

* git repository: https://github.com/IvanSpirandelli/AlphaMolWrapper (revision: `4bd6559a12b4f561e6d880d03d1e3a799768827a`)

## Platforms

`AlphaMolWrapper_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `AlphaMolWrapper_jll.jl`:
...
* `LibraryProduct`: `libalphamolwrapper`
